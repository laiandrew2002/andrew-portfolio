      ...
      <Container>
                ...
                <div className='flex flex-col justify-center gap-4 pt-20 pb-20'>
                  ...
                  <div className='mt-5'>
                    <Button className="flex items-center gap-x-2" variant="secondary" arrow="right">
                      <Link href="https://app.bake.io" target="_blank" rel="noopener noreferrer">
                        Visit Website
                      </Link>
                    </Button>
                  </div>
        ...
        <FadeIn>
          ...
          <Section id="featuresOwned">
            <div className='flex flex-col pt-10 mb-20'>
              <AppPageHeader icon={<MdOutlineFeaturedPlayList size={28} fill='#41d985'/>} title="Features Owned and Implemented" />
          ...
          <Section id="keyOutcomes">
            <div className='flex flex-col pt-10 mb-20'>
              <AppPageHeader icon={<TbCircleKeyFilled size={28} fill='#ed8864'/>} title="Key Outcomes" />
              <ul className="list-disc pl-6 mt-1 text-gray-500">
                <li className="text-md py-1">
                  30% improvement in user onboarding time due to SSO integration.
                </li>
                <li className="text-md py-1">
