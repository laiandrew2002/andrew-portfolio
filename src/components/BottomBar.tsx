...
const BottomBar = () => {
  return (
    <div className="flex select-none justify-between border-t-2 border-dark_border text-sm text-gray-500">
      <div className="flex cursor-pointer items-center gap-1">
        <div className="0 bg-blue-300">
          <Tooltip
            icon={<Remote />}
  ...
  return (
    <div className="relative">
      <div
        ...
        className={clsx('relative p-1 px-2 hover:bg-gray-300', className)}
      >
        {icon}
      </div>
